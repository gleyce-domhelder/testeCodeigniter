          ...
          <div class="tab-content">
            <div class="tab-pane fade active show" id="chat" role="tabpanel">
                  ...
                  <ul class="contacts">
                    ...
                    <li class="active dz-chat-user">
                      <div class="d-flex bd-highlight">
                        <div class="img_cont">
                          <img class="rounded-circle user_img" alt="" />
              ...
              <div class="card chat dz-chat-history-box d-none">
                <div class="card-header chat-list-header text-center">
                  <a href="" class="dz-chat-history-back"></a>
                  <div>
                ...
                >
                  <div class="d-flex justify-content-start mb-4">
                    <div class="img_cont_msg">
                      <img class="rounded-circle user_img_msg" alt="" />
                    </div>
                      ...
                      <div class="header-info2 d-flex align-items-center">
                        ...
                        <div class="header-info">
                          ...
                          <p>
                            <span
                              class="__cf_email__"
                              data-cfemail="fa93949c95ba9d979b9396d4999597"
                            >
                              [email&#160;protected]
                            </span>
                          </p>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <div class="card border-0 mb-0">
                        <div class="card-header py-2">
                          <div class="products">
                            <img src="" class="avatar avatar-md" alt="" />
                            <div>
                              <h6>Thomas Fleming</h6>
                        ...
                        <div class="card-body px-0 py-2">
                          ...
                          >
                            ...
                            <span class="badge badge-sm badge-secondary light rounded-circle text-white ms-2">
                              4
                            </span>
                          </a>
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              <a class="has-arrow " href="" aria-expanded="false">
                <div class="menu-icon">
                  ...
                  >
                    <g clip-path="url(#clip0_14_1294)">
                      ...
                      />
                      <path
                        d="M17.4903 3.80664H13.5771V18.1013H17.4903V3.80664Z"
                        stroke="#888888"
                      />
                      <mask id="mask0_14_1294">
                        <path
                ...
                <span class="nav-text">
                  AIKit<span class="badge badge-info badge-xs ms-1">HOT</span>
                </span>
              </a>
              <ul aria-expanded="false">
                <li>
                  <a href="auto-write.html">Auto Writer</a>
                </li>
                <li>
                  <a href="scheduled.html">Scheduler</a>
                </li>
                <li>
                ...
                <li>
                  <a href="fine-tune-models.html">Fine-tune Models</a>
                </li>
                <li>
                  <a href="prompt.html">AI Menu Prompts</a>
                </li>
                <li>
                  <a href="setting.html">Settings</a>
                </li>
                <li>
                  <a href="import.html">Export/Import Settings</a>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul aria-expanded="false">
                ...
                <li class="extra-menu-li">
                  <ul
                    id="collapseExample"
                    class="pt-0 extra-menu-links extra-menu-area"
                  >
                    <li>
                  ...
                  <a
                    class="btn show-more-btn border-0"
...
const Cadastro = () => {
  const [modulos, setModulos] = useState({
    usuarios: ["Listar Usuários", "Excluir Usuários", "Alterar Usuários"],
    produtos: ["Visualizar Produtos", "Remover Produtos", "Editar Produtos"],
    vendas: ["Ver Vendas", "Excluir Vendas", "Modificar Vendas"],
  });

  const handleSelectAll = () => {
    const updatedModulos = {};
    Object.keys(modulos).forEach((menu) => {
      updatedModulos[menu] = modulos[menu].map((modulo) => ({
        nome: modulo,
        selecionado: true,
      }));
    });
  ...
  const handleCheckboxChange = (menu, index) => {
    const updatedModulos = { ...modulos };
    updatedModulos[menu][index].selecionado =
      !updatedModulos[menu][index].selecionado;
    setModulos(updatedModulos);
  };
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Dados do formulário:", { modulos });
  };
                        ...
                        <div className="container mt-4">
                          ...
                          <div className="table-responsive">
                            <div className="container">
                              <h2 className="my-4">Cadastro de Perfil</h2>
                              <form onSubmit={handleSubmit}>
                                <h3>Permissões de Módulos</h3>
                                <div className="mb-3">
                                  <button
                                    type="button"
